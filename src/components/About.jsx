 ...
 const About =()=> {
  ...
  return (
    <>
      ...
      <div className="abt">
      <div className="abt1">
      <span className="vertical1">The</span>
      ...
      <div className="content">
        ...
        <div className="body">
        <div className='body1'>
        <img src={require('../images/mask.png')} alt="" className='image1'/>
        ...
        <div className="img3">
        <img src={require('../images/pro.png')} alt="" className='image3'/>
        </div>
        <div className='small'>
        ...
        <div className="clap">
            <img src={require('../images/clap.png')} alt="" className='image4' />
    ...
    <div className="bottomdown">
    {
      ...
      <div className="side">
            <div>
            <img src={require('../images/clap.png')} alt="" className='sideimg1' />
            <span className='sideclap'>9.3K claps</span>
            </div>
           <div>
           <img src={require('../images/share.png')} alt="" className='sideimg2' />
